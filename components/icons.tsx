...
export const WelcomeIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const EyeOffIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M10.73 10.73C12.45 9.42 15.48 9.21 17.5 10.5c2.6 1.6 4.5 4.5 4.5 4.5s-1.9 2.9-4.5 4.5c-2.02 1.29-5.05 1.08-6.77-.23" />
